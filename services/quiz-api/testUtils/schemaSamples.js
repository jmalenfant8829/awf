...
module.exports.getTestUser = function() {
    ...
    quiz1question1 = new Question({ description: faker.lorem.sentence(),});
    quiz1question2 = new Question({ description: faker.lorem.sentence(), });
    quiz2question1 = new Question({ description: faker.lorem.sentence(), });
    quiz2question2 = new Question({ description: faker.lorem.sentence(), });
